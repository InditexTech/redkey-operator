...
// TestReconcileScaleToZero_NewClusterZeroPrimaries verifies that creating a Redkey with
// primaries=0 does NOT create any RedkeyConfig, Robin Deployment, or RBAC resources.
func TestReconcileScaleToZero_NewClusterZeroPrimaries(t *testing.T) {
	...
	var configs redisv1.RedkeyConfigList
...
// is scaled to 0, the operator creates a new RedkeyConfig with primaries=0 while keeping Robin alive.
...
func TestReconcileScaleToZero_WaitsForApplied(t *testing.T) {
	...
	var existingConfig redisv1.RedkeyConfig
